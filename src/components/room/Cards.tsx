import { Avatar, HStack, Menu, MenuButton, MenuItem, MenuList, SimpleGrid, VStack, Button, Text, AvatarGroup, IconButton} from '@chakra-ui/react'
...
export const Cards = ({ data, showAlertDl, showUpdate}: { data: roomType[], showAlertDl?: any, showUpdate?: any }) => {
	return (
		<SimpleGrid w={'full'} minChildWidth="300px" spacing={10}>
			{data.map((item, key) => (
				<VStack
					overflow={'hidden'}
					paddingTop={4}
